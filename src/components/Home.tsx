    ...
    <main className="home-main bg-[url('/bg-home.png')] bg-cover bg-center bg-fixed">
      <section className="">
        <div className="container flex flex-col h-screen items-center justify-center text-white">
          <div className="text-[3.2rem] md:text-[5rem] text-center font-bold">VOGUENEST</div>
          <div className="font-medium">FASHION COLLECTION</div>
        </div>
          ...
          <div className="w-full flex items-end justify-end">
            <div className="flex flex-col w-full md:w-1/2 items-start gap-8 mb-10 justify-between text-[#E53935]">
              ...
              <div className="font-semibold text-[1.5rem]">
                Our collection features timeless pieces designed for the modern
                individual. Quality over quantity is our mantra. Discover a
                wardrobe that reflects your essence.
              </div>
              <div className="mt-4">
              <a href="/shop" className="border hover:bg-black font-semibold text-sm text-white border-black px-2 py-2 bg-[#E53935] transition-all duration-300">SHOP NOW</a></div>
            </div>
          </div>+
        </div>
      </section>
      <footer className="bg-transparent">
        <div>
          <div className="newsletter w-full pt-28 pb-40">
          ...
          <div className="container container-xl-custom pt-10 md:pt-28">
            <div className="w-full md:flex items-start justify-between">
              <div className="flex flex-col items-center md:items-start gap-8 mb-12 md:mb-0 md:w-1/3">
                ...
                <div className="flex flex-col text-center md:text-start gap-2 text-white text-sm md:text-lg font-medium">
                  <div>
