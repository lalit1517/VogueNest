...
const Cart = () => {
    ...
    const handleSubmitForm = async () => {
        ...
        const options = {
            ...
            image: "https:localhost:5173/logo.svg",
    ...
    const pageContent = confirm
        ...
        : <>
            ...
            <div className="cart__totals">
                ...
                <button className="cart__submit" disabled={!totalItems} onClick={onPlaceOrderClick}>
                    Place Order
                </button>
            </div>
        </>;
        ...
        <main className="main main--cart">
            ...
            <Modal isOpen={showModal} onClose={() => setShowModal(false)}>
                ...
                <form className="cart__form" onSubmit={(e) => {
                    ...
                    <button type="submit" className="modal-close">Submit and Pay</button>
                </form>
            </Modal>
        </main>
    );
